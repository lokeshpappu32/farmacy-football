    ...
    <div className="min-h-screen bg-stadium field-lines px-4 py-8">
      ...
      <form onSubmit={submit} className="glass mx-auto max-w-2xl rounded-3xl p-6">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <label className="text-sm font-bold md:col-span-2">MR ID<input required className="input mt-2" value={form.mr_id} onChange={(e) => update("mr_id", e.target.value)} placeholder="Fill the MR ID her" /></label>
        </div>
